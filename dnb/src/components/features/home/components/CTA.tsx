...
export default function CTA() {
  ...
  return (
    <section className="w-full rounded-lg  text-center">
      <h2 className="mb-4 mt-4 text-4xl font-bold text-foreground sm:text-5xl">
      ...
      <p className="mt-16 text-sm text-muted-foreground mb-4">
