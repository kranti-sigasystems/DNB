...
export default function Hero() {
  ...
  return (
    <section className="w-full min-h-screen flex items-center bg-linear-to-br p-4 from-slate-50 via-blue-50 to-indigo-50 overflow-hidden">
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-0 w-full">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            >
              <div className="flex items-center justify-center w-6 h-6 bg-linear-to-br from-indigo-500 to-purple-600 rounded-full">
                <Award className="w-3.5 h-3.5 text-white" />
              </div>
              <span className="text-sm font-medium bg-linear-to-br from-indigo-600 to-purple-600 bg-clip-text text-transparent">
            ...
            >
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-none">
                ...
                <span className="block bg-linear-to-br from-blue-600 via-indigo-600 pb-3 to-purple-600 bg-clip-text text-transparent">
                  Negotiation Book
                </span>
              </h1>
            ...
            >
              <div className="group flex items-center gap-2 px-4 py-2.5 bg-white/90 backdrop-blur-sm rounded-xl border border-emerald-200 shadow-sm hover:shadow-md hover:border-emerald-300 transition-all duration-300">
                <div className="flex items-center justify-center w-8 h-8 bg-linear-to-br from-emerald-400 to-emerald-600 rounded-lg group-hover:scale-110 transition-transform">
              ...
              <div className="group flex items-center gap-2 px-4 py-2.5 bg-white/90 backdrop-blur-sm rounded-xl border border-blue-200 shadow-sm hover:shadow-md hover:border-blue-300 transition-all duration-300">
                <div className="flex items-center justify-center w-8 h-8 bg-linear-to-br from-blue-400 to-blue-600 rounded-lg group-hover:scale-110 transition-transform">
              ...
              <div className="group flex items-center gap-2 px-4 py-2.5 bg-white/90 backdrop-blur-sm rounded-xl border border-purple-200 shadow-sm hover:shadow-md hover:border-purple-300 transition-all duration-300">
                <div className="flex items-center justify-center w-8 h-8 bg-linear-to-br from-purple-400 to-purple-600 rounded-lg group-hover:scale-110 transition-transform">
          ...
          >
            <div className="relative">
              ...
              {floatingCards.map((card, index) => (
                <div
                  key={card.id}
                  className={`absolute z-1 w-22 h-22 rounded-2xl shadow-2xl flex items-center justify-center transform transition-all duration-300 ${
                    index === 0
                      ? '-top-8 -left-8 bg-white hover:rotate-6'
                      : '-bottom-8 -right-8 bg-linear-to-br from-purple-500 to-pink-600 hover:-rotate-6'
                  }`}
                  style={{
                    transform:
                      index === 0
                ...
                >
                  {index === 0 ? (
                    <div className="text-center">
                      <div className="text-3xl font-bold bg-linear-to-br from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                        98%
                      </div>
