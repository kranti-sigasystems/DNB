...
export default function Testimonials() {
  ...
  return (
    <section className="py-20">
      {/* Heading */}
      <h2 className="mb-12 text-center text-5xl font-bold text-foreground">What Our Users Say</h2>
      ...
      <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-3">
        {testimonials.map((t) => (
          ...
          >
            ...
            {/* Feedback */}
            <p className="mb-6 text-sm text-muted-foreground sm:text-base leading-relaxed">{t.feedback}</p>
