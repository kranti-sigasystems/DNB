      ...
      try {
        ...
        if (storedUser.paymentId && process.env.VITE_API_URL) {
          const res = await fetch(
            `${process.env.VITE_API_URL}/payments/${storedUser.paymentId}`
          );
          if (res.ok) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg mb-8">
          <div className="px-6 sm:px-8 py-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
              <div className="flex items-center gap-4">
                <div className="h-20 w-20 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400 text-2xl font-semibold">
                  {avatarInitials}
                </div>
                <div>
              ...
              <Button className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 text-white gap-2">
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg">
          <Tabs defaultValue="profile" className="w-full">
            <div className="border-b border-gray-200 dark:border-gray-800 px-6 sm:px-8">
              <TabsList className="bg-transparent border-b-0 w-full justify-start gap-8 h-auto p-0">
                <TabsTrigger
                  value="profile"
                  className="bg-transparent  text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-500 rounded-none px-0 py-4 font-medium text-sm"
                >
            ...
            <TabsContent value="subscription" className="p-6 sm:p-8">
              {plan ? (
                <div className="space-y-8">
                  <div className="border border-blue-200 dark:border-blue-800 rounded-lg p-8 bg-gradient-to-br from-blue-50 dark:from-blue-900/20 to-blue-100 dark:to-blue-900/10">
                    ...
                    <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-6 bg-white dark:bg-gray-800">
                      <div className="grid sm:grid-cols-2 gap-4">
                        {payment?.Plan?.features ? (
                          (() => {
                            const features =
                              typeof payment.Plan.features === "string"
                  ...
                  <div>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                      <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-6 bg-white dark:bg-gray-800 hover:shadow-md dark:hover:shadow-lg transition-shadow">
                      ...
                      <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-6 bg-white dark:bg-gray-800 hover:shadow-md dark:hover:shadow-lg transition-shadow">
                        ...
                        <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">
                          {payment?.Plan?.maxUsers || "Unlimited"}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="border border-gray-200 dark:border-gray-800 rounded-lg divide-y dark:divide-gray-800 bg-white dark:bg-gray-800">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-4">
                    <Button className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 text-white gap-2 flex-1">
                      <Download className="w-4 h-4" />
                      Download Invoice
                    </Button>
                    <Button
                      variant="outline"
                      className="flex-1 gap-2 border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800"
                    >
                ...
                <div className="text-center py-16">
                  <Package className="h-16 w-16 mx-auto text-gray-300 dark:text-gray-700 mb-4" />
